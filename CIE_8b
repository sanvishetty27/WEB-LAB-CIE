...
<head> 
 ...
 <style> 
 body { font-family: Arial, sans-serif; text-align: center; margin-top: 20px; }  table { margin: auto; border-collapse: collapse; width: 80%; }  th, td { padding: 10px; border: 1px solid #ddd; } 
...
<body> 
 ...
 <?php 
 $conn = new mysqli("localhost", "root", "", "students123"); 
 $students = $conn->query("SELECT * FROM  
students123")->fetch_all(MYSQLI_ASSOC);
